define_locations_table <- function() {
  dplyr::bind_rows(
    ...
    tibble::tibble(location = "South_Sandwich_Islands_120m", lon = -26.5, lat = -57.75, radiusx = 150000, radiusy = 150000, resolution = 120, purpose = "island"),
    tibble::tibble(location = "South_Sandwich_Islands_65m",  lon = -26.4, lat = -58.5,  radiusx = 80000,  radiusy = 80000,  resolution = 65, purpose = "island"),
    ...
    tibble::tibble(location = "Dickson_Fjord", lon = -26.95, lat = 72.81, purpose = "climate,island"),
    tibble::tibble(location = "A23A", lon = -41.06, lat = -75.79, purpose = "iceberg,antarctica"),
